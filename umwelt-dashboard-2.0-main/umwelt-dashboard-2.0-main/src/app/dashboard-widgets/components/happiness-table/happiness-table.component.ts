...
@Component({
  selector: 'app-happiness-table',
  templateUrl: './happiness-table.component.html',
  styleUrls: ['./happiness-table.component.scss']
})
export class HappinessTableComponent implements OnInit {
  ...
  public dataPlotObj: string;
    ...
    //     } else {
    //         let status = "";
    //         if (result.datasetName == 'Awesome') {
    //           status = 'Awesome';
    //         } else if (result.datasetName == 'Happy') {
    //           status = 'Happy';
    //         } else if (result.datasetName == 'Neutral') {
    //           status = 'Neutral';
    //         } else if (result.datasetName == 'Sad') {
    //           status = 'Sad';
    //         } else if (result.datasetName == 'Awful') {
    //           status = 'Awful';
    ...
    onClickingReset() {
      this.dashboardService.getEmployees('happiness').subscribe( data => {
        this.rows = data;
      });
    }
    ...
    onSort(event) {
      ...
      this.dashboardService.getEmployees('happiness', event.newValue, event.column.prop).subscribe( data => {
        this.rows = data;
        this.loading = false;
      });
    }
